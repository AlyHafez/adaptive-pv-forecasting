...
class FileConfig:
    ...
    household3_test_set:str = os.path.join(processed_data_dir, "ukpv_london_test_household3.parquet")
    ...
    household3_test_set_shaded:str = os.path.join(processed_data_dir, "ukpv_london_test_household3_shaded.parquet")
    household3_test_set_drifted:str = os.path.join(processed_data_dir, "ukpv_london_test_household3_drifted.parquet")
